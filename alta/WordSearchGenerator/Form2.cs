...
namespace WordSearchGenerator
{
    public partial class Form2 : Form
    {
        ...
        private TransparentLetter AddLetter(Litera labelLetter, int x, int y)
        {
